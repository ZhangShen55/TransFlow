...
2026-09-10 使用相同多语种负载完成 `max_num_seqs=128/192/256/384/512` A/B 测试，每档为 64 并发、128 请求。512 在测试范围内最佳，输出吞吐 15,712.520 token/秒，P95 为 46.320 秒，KV Cache 峰值 5.160%，无错误、OOM 或 preemption；但尚未执行 512 的持续负载验证，因此当前默认值仍为 256。详细结果见 `docs/ab-max-num-seqs-c64-r128.md`。
